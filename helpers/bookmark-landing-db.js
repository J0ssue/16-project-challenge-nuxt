export default {
  header: {
    title: 'a simple bookmark <br class="hidden lg:inline"> manager',
    description:
  ...
  features: {
    ...
    tabs: [
      {
        slug: 'simple-bookmarking',
        tab: 'Simple Bookmarking',
        img: '/bookmark-landing/illustration-features-tab-1.svg',
        title: 'Bookmark in one click',
        description:
          'Organize your bookmarks however you like. Our simple drag-and-drop interface gives you complete control over how you manage your favourite sites.'
      },
      {
        slug: 'speedy-searching',
        tab: 'Speedy Searching',
        img: '/bookmark-landing/illustration-features-tab-2.svg',
      ...
      },
      {
        slug: 'easy-sharing',
        tab: 'Easy Sharing',
        img: '/bookmark-landing/illustration-features-tab-3.svg',
        title: 'Share your bookmarks',
        description:
          'Easiliy share çyour bookmarks and collections with others. Create a shareable link that you can send at the click of a button.'
      }
    ]
  },
  availability: {
    ...
    browsers: [
      {
        slug: 'chrome',
        img: '/bookmark-landing/logo-chrome.svg',
        title: 'Add to Chrome',
        version: 'Minimum version 62'
      },
      {
        slug: 'firefox',
        img: '/bookmark-landing/logo-firefox.svg',
        title: 'Add to Firefox',
        version: 'Minimum version 55'
      },
      {
        slug: 'opera',
        img: '/bookmark-landing/logo-opera.svg',
        title: 'Add to Opera',
  ...
  cta: {
    uppertext: '35,000+ ALREADY JOINED',
  ...
  footer: {
    ...
    icons: [
      ...
      '/bookmark-landing/icon-twitter.svg'
    ]
  }
}
